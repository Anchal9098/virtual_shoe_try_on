...
while cap.isOpened() and frame_count < max_frames:
    ...
    if result.pose_landmarks:
        ...
        foot_positions.append((shoe_x, shoe_y))
        print("Foot Position:", shoe_x, shoe_y)
...
print("\nTotal Foot Positions Detected:", len(foot_positions))
print("All Positions:", foot_positions)
